...
// Set is a struct to manage application environment configurations.
...
// when you create the new Set struct you can set the DefaultMode field to a string of your choice.
...
func (e *Set) AppKey() (string, error) {
...
func (e *Set) GetOr(val string, def string) string {
